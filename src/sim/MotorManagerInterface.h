...
namespace mars
{
    ...
    namespace interfaces
    {
        ...
        public:
             ...
             */
            virtual unsigned long addMotor(MotorData *motorS, std::weak_ptr<JointInterface> joint, std::string frame, bool reload = false) = 0;
             ...
             */
            virtual core::SimMotor* getSimMotor(unsigned long index) const = 0;
             ...
             * \returns Returns a pointer to the corresponding motor object.
             */
            virtual core::SimMotor* getSimMotorByName(const std::string &name) const = 0;
